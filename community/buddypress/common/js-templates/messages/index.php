<?php
/**
 * BP Progenitor Messages main template.
 *
...
<script type="text/html" id="tmpl-bp-messages-form">
	<?php bp_progenitor_messages_hook( 'before', 'compose_content' ); ?>
	...
	<?php bp_progenitor_messages_hook( 'after', 'compose_content' ); ?>
...
<script type="text/html" id="tmpl-bp-messages-editor">
	...
	add_filter( 'mce_buttons', 'bp_progenitor_mce_buttons', 10, 1 );
	...
	// Temporarly filter the editor
	remove_filter( 'mce_buttons', 'bp_progenitor_mce_buttons', 10, 1 ); ?>
</script>
...
<script type="text/html" id="tmpl-bp-messages-single-header">
	...
	<header class="single-message-thread-header">
		...
		<div class="actions">
			...
			<?php bp_progenitor_messages_hook( 'after', 'thread_header_actions' ); ?>
		</div>
	</header>
</script>
...
<script type="text/html" id="tmpl-bp-messages-single-list">
	<div class="message-metadata">
		<?php bp_progenitor_messages_hook( 'before', 'meta' ); ?>
		...
		<?php bp_progenitor_messages_hook( 'after', 'meta' ); ?>

	</div>

	<?php bp_progenitor_messages_hook( 'before', 'content' ); ?>

	<div class="message-content"><# print( data.content ) #></div>

	<?php bp_progenitor_messages_hook( 'after', 'content' ); ?>

</script>

<script type="text/html" id="tmpl-bp-messages-single">
	<?php bp_progenitor_messages_hook( 'before', 'thread_content' ); ?>

	<div id="bp-message-thread-header" class="message-thread-header"></div>

	<?php bp_progenitor_messages_hook( 'before', 'thread_list' ); ?>

	<ul id="bp-message-thread-list"></ul>

	<?php bp_progenitor_messages_hook( 'after', 'thread_list' ); ?>

	<?php bp_progenitor_messages_hook( 'before', 'thread_reply' ); ?>
	...
	<form id="send-reply" class="standard-form send-reply">
		<div class="message-box">
			...
			<div class="message-content">
				...
				<?php bp_progenitor_messages_hook( 'before', 'reply_box' ); ?>

				<label for="message_content" class="bp-screen-reader-text"><?php _e( 'Reply to Message', 'buddypress' ); ?></label>
				<div id="bp-message-content"></div>

				<?php bp_progenitor_messages_hook( 'after', 'reply_box' ); ?>
	...
	<?php bp_progenitor_messages_hook( 'after', 'thread_reply' ); ?>

	<?php bp_progenitor_messages_hook( 'after', 'thread_content' ); ?>
</script>
