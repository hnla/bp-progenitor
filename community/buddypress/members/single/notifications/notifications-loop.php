<?php
/**
 * BuddyPress - Progenitor Members Notifications Loop
 *
 * @since 1.0.0
 */
...
if ( bp_has_notifications( bp_ajax_querystring( 'notifications' ) ) ) :
	...
	<form action="" method="post" id="notifications-bulk-management" class="standard-form">
			...
			<thead>
				<tr>
					...
					<th class="date">
						...
						<?php bp_progenitor_notifications_sort_order_links(); ?>
					</th>
		...
		<div class="notifications-options-nav">
			<?php bp_progenitor_notifications_bulk_management_dropdown(); ?>
	...
	bp_progenitor_user_feedback( 'member-notifications-none' );
