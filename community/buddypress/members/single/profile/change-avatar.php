<?php
/**
 * BuddyPress - Progenitor Members Profile Change Avatar
 *
 * @since 1.0.0
 */
?>
...
<?php bp_progenitor_xprofile_hook( 'before', 'avatar_upload_content' ); ?>
...
<?php bp_progenitor_xprofile_hook( 'after', 'avatar_upload_content' );
