<?php
/**
 * BuddyPress - Progenitor Members Profile Change Cover Image
 *
 * @since 1.0.0
 */
...
<?php bp_progenitor_xprofile_hook( 'before', 'edit_cover_image' ); ?>
...
bp_progenitor_xprofile_hook( 'after', 'edit_cover_image' );
