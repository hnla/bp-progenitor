<?php
/**
 * BuddyPress - Progenitor Members Settings ( Notifications )
 *
 * @since 1.0.0
 */
...
<form action="<?php echo esc_url( bp_displayed_user_domain() . bp_get_settings_slug() . '/notifications' ); ?>" method="post" class="standard-form" id="settings-form">
	...
	<?php bp_progenitor_member_email_notice_settings() ; ?>

	<?php bp_progenitor_submit_button( 'member-notifications-settings' ); ?>
