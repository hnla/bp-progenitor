<?php
/**
 * BuddyPress - Progenitor Members Settings ( Delete Account )
 *
 * @since 1.0.0
 */
...
<?php bp_progenitor_user_feedback( 'member-delete-account' ); ?>
...
<form action="<?php echo esc_url( bp_displayed_user_domain() . bp_get_settings_slug() . '/delete-account' ); ?>" name="account-delete-form" id="#account-delete-form" class="standard-form" method="post">
	...
	<?php bp_progenitor_submit_button( 'member-delete-account' ); ?>
