<?php
/**
 * Add  specific panels for the BP progenitor main site & BP components.
 * Add Sections & section controls.
 *
 * @see /community/includes/functions.php bp_progenitor_get_appearence_settings()
 * for default control settings.
 *
 * @since 0.1.0
 *
 * @param WP_Customize_Manager $wp_customize WordPress customizer.
 */
function bp_progenitor_customize_register( WP_Customize_Manager $wp_customize ) {
	if ( ! bp_is_root_blog() ) {
		return;
	}
	...
	$wp_customize->register_control_type( 'BP_Progenitor_Nav_Customize_Control' );
	$bp_progenitor_options = bp_progenitor_get_appearance_settings();

	$wp_customize->add_panel( 'bp_progenitor_panel', array(
		'description' => __( 'Customize the appearance of BuddyPress Progenitor.', 'buddypress' ),
		'title'       => _x( 'BP Progenitor Settings', 'Customizer Panel', 'buddypress' ),
		'priority'    => 10,
	) );

	$sections = apply_filters( 'bp_progenitor_customizer_sections', array(
		'bp_progenitor_site_settings' => array(
			'title'       => __( 'General Site Settings', 'buddypress' ),
			'panel'       => 'bp_progenitor_panel',
			'priority'    => 10,
			'description' => __( 'Set general Site layout Options.', 'buddypress' ),
		),
		'bp_progenitor_general_settings' => array(
			'title'       => __( 'General BP Options', 'buddypress' ),
			'panel'       => 'bp_progenitor_panel',
			'priority'    => 20,
			'description' => __( 'Set general BuddyPress styles', 'buddypress' ),
		),
		'bp_progenitor_site_header' => array(
			'title'       => __( 'Site Header Options', 'buddypress' ),
			'panel'       => 'bp_progenitor_panel',
			'priority'    => 30,
			'description' => __( 'Set Site header image/logo options', 'buddypress' ),
		),
		'bp_progenitor_user_front_page' => array(
			'title'       => __( 'User\'s front page', 'buddypress' ),
			'panel'       => 'bp_progenitor_panel',
			'priority'    => 40,
			'description' => __( 'Set your preferences about the members default front page.', 'buddypress' ),
		),
		'bp_progenitor_user_primary_nav' => array(
	...
	$settings = apply_filters( 'bp_progenitor_customizer_settings', array(
		...
		'bp_progenitor_appearance[main_site_menu]' => array(
			'index'             => 'main_site_menu',
			'capability'        => 'bp_moderate',
		...
		'bp_progenitor_appearance[post_loops_grid_archives]' => array(
			'index'             => 'post_loops_grid_archives',
			'capability'        => 'bp_moderate',
			'sanitize_callback' => 'absint',
			'transport'         => 'refresh',
			'type'              => 'option',
		),
		'bp_progenitor_appearance[post_loops_grid_search]' => array(
			'index'             => 'post_loops_grid_search',
			'capability'        => 'bp_moderate',
			'sanitize_callback' => 'absint',
			'transport'         => 'refresh',
			'type'              => 'option',
		),
		'bp_progenitor_appearance[post_loops_grid_tags]' => array(
			'index'             => 'post_loops_grid_tags',
			'capability'        => 'bp_moderate',
			'sanitize_callback' => 'absint',
			'transport'         => 'refresh',
			'type'              => 'option',
		),
		'bp_progenitor_appearance[post_loops_grid_author]' => array(
			'index'             => 'post_loops_grid_author',
			'capability'        => 'bp_moderate',
			'sanitize_callback' => 'absint',
			'transport'         => 'refresh',
			'type'              => 'option',
		...
		'bp_progenitor_appearance[user_front_page]' => array(
		...
		'bp_progenitor_appearance[user_front_bio]' => array(
		...
		'bp_progenitor_appearance[user_nav_display]' => array(
		...
		'bp_progenitor_appearance[user_nav_tabs]' => array(
			'index'             => 'user_nav_tabs',
			'capability'        => 'bp_moderate',
			'sanitize_callback' => 'absint',
			'transport'         => 'refresh',
		...
		'bp_progenitor_appearance[user_subnav_tabs]' => array(
		...
		'bp_progenitor_appearance[user_nav_order]' => array(
		...
		'bp_progenitor_appearance[members_layout]' => array(
		...
		'bp_progenitor_appearance[members_group_layout]' => array(
		...
		'bp_progenitor_appearance[members_friends_layout]' => array(
		...
		'bp_progenitor_appearance[activity_dir_layout]' => array(
		...
		'bp_progenitor_appearance[activity_dir_tabs]' => array(
		...
		'bp_progenitor_appearance[members_dir_layout]' => array(
		...
		'bp_progenitor_appearance[members_dir_tabs]' => array(
		...
		'bp_progenitor_appearance[groups_dir_layout]' => array(
		...
		'bp_progenitor_appearance[groups_dir_tabs]' => array(
		...
		'bp_progenitor_appearance[sites_dir_layout]' => array(
		...
		'bp_progenitor_appearance[sites_dir_tabs]' => array(
	...
	foreach ( $settings as $id_setting => $setting_args ) {
		...
		if ( empty( $setting_args['index'] ) || ! isset( $bp_progenitor_options[ $setting_args['index'] ] ) ) {
			continue;
		}

		$args = array_merge( $setting_args, array( 'default' => $bp_progenitor_options[ $setting_args['index'] ] ) );

		$wp_customize->add_setting( $id_setting, $args );
	}

	$controls = apply_filters( 'bp_progenitor_customizer_controls', array(
		'main_site_menu' => array(
			'label'      => __( 'Select Horizontal or vertical positioning for header/menu', 'buddypress' ),
			'section'    => 'bp_progenitor_site_settings',
			'settings'   => 'bp_progenitor_appearance[main_site_menu]',
			'type'       => 'radio',
			'choices' => array(
		...
		'post_loops_grid_archives' => array(
			'label'      => __( 'Display the post list Archive/Category loops as grid boxes', 'buddypress' ),
			'section'    => 'bp_progenitor_site_settings',
			'settings'   => 'bp_progenitor_appearance[post_loops_grid_archives]',
			'type'       => 'checkbox',
		),
		'post_loops_grid_search' => array(
			'label'      => __( 'Display the post list Search results loop as grid boxes', 'buddypress' ),
			'section'    => 'bp_progenitor_site_settings',
			'settings'   => 'bp_progenitor_appearance[post_loops_grid_search]',
			'type'       => 'checkbox',
		),
		'post_loops_grid_tags' => array(
			'label'      => __( 'Display the post list Tags loop as grid boxes', 'buddypress' ),
			'section'    => 'bp_progenitor_site_settings',
			'settings'   => 'bp_progenitor_appearance[post_loops_grid_tags]',
			'type'       => 'checkbox',
		),
		'post_loops_grid_author' => array(
			'label'      => __( 'Display the post list Author loop as grid boxes', 'buddypress' ),
			'section'    => 'bp_progenitor_site_settings',
			'settings'   => 'bp_progenitor_appearance[post_loops_grid_author]',
			'type'       => 'checkbox',
		),
		'bp_dir_sbar' => array(
		...
		'site_tagline' => array(
			...
			'section'    => 'bp_progenitor_site_header',
			'settings'   => 'bp_progenitor_appearance[site_tagline]',
			'type'       => 'checkbox',
		),
		'header_img_background' => array(
			'label'      => __( 'Display the header image as a background', 'buddypress' ),
			'section'    => 'bp_progenitor_site_header',
		...
		'bp_site_avatars' => array(
			...
			'section'    => 'bp_progenitor_general_settings',
			'settings'   => 'bp_progenitor_appearance[avatar_style]',
			'type'       => 'checkbox',
		),
		'user_front_page' => array(
			'label'      => __( 'Enable default front page for user profiles.', 'buddypress' ),
			'section'    => 'bp_progenitor_user_front_page',
			'settings'   => 'bp_progenitor_appearance[user_front_page]',
			'type'       => 'checkbox',
		),
		'user_front_bio' => array(
			'label'      => __( 'Display the WordPress Biographical Info of the user.', 'buddypress' ),
			'section'    => 'bp_progenitor_user_front_page',
			'settings'   => 'bp_progenitor_appearance[user_front_bio]',
			'type'       => 'checkbox',
		),
		'user_nav_display' => array(
			'label'      => __( 'Display the User\'s primary nav vertically.', 'buddypress' ),
			'section'    => 'bp_progenitor_user_primary_nav',
			'settings'   => 'bp_progenitor_appearance[user_nav_display]',
			'type'       => 'checkbox',
		),
		'user_nav_tabs' => array(
			'label'      => __( 'Set User nav to tab style.', 'buddypress' ),
			'section'    => 'bp_progenitor_user_primary_nav',
			'settings'   => 'bp_progenitor_appearance[user_nav_tabs]',
			'type'       => 'checkbox',
		),
		'user_subnav_tabs' => array(
			'label'      => __( 'Set User subnav to tab style.', 'buddypress' ),
			'section'    => 'bp_progenitor_user_primary_nav',
			'settings'   => 'bp_progenitor_appearance[user_subnav_tabs]',
			'type'       => 'checkbox',
		),
		'user_nav_order' => array(
			...
			'section'    => 'bp_progenitor_user_primary_nav',
			'settings'   => 'bp_progenitor_appearance[user_nav_order]',
			'type'       => 'user',
		),
		'members_layout' => array(
			'label'      => __( 'Members loop.', 'buddypress' ),
			'section'    => 'bp_progenitor_loops_layout',
			'settings'   => 'bp_progenitor_appearance[members_layout]',
			'type'       => 'select',
		...
		'members_group_layout' => array(
			...
			'section'    => 'bp_progenitor_loops_layout',
			'settings'   => 'bp_progenitor_appearance[members_group_layout]',
			'type'       => 'select',
			'choices'    => bp_progenitor_customizer_grid_choices(),
		),
 ...
 * @since 1.0.0
 */
function bp_progenitor_customizer_enqueue_scripts() {
	$min = bp_core_get_minified_asset_suffix();

	wp_enqueue_script(
		'bp-progenitor-customizer',
		...
		bp_progenitor()->version,
		true
	);

	do_action( 'bp_progenitor_customizer_enqueue_scripts' );
}
add_action( 'customize_controls_enqueue_scripts', 'bp_progenitor_customizer_enqueue_scripts' );
