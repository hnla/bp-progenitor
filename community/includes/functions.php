 ...
 */
function bp_progenitor_ajax_querystring( $query_string, $object ) {
	if ( empty( $object ) ) {
		return '';
	}
	 ...
	 */
	return apply_filters( 'bp_progenitor_ajax_querystring', $query_string, $object, $filter, $scope, $page, $search_terms, $extras );
}
 ...
 * @return string
 */
function bp_progenitor_ajax_button( $output ='', $button = null, $before ='', $after = '', $r = array() ) {
 ...
 * }
 */
function bp_progenitor_wrapper( $args = array() ) {
 /**
 ...
 * @since 1.0.0
 */
function bp_progenitor_register_sidebars() {
	$default_fronts      = bp_progenitor_get_appearance_settings();
	...
	if ( is_customize_preview() ) {
		$default_user_front = bp_progenitor_get_temporary_setting( 'user_front_page', $default_user_front );

		if ( $is_active_groups ) {
			$default_group_front = bp_progenitor_get_temporary_setting( 'group_front_page', $default_group_front );
		}
	}
 ...
 * @return bool
 */
function bp_progenitor_is_object_nav_in_sidebar() {
	return is_active_widget( false, false, 'bp_progenitor_sidebar_object_nav_widget', true );
}
 ...
 * @return bool
 */
function bp_progenitor_current_user_can( $capability = '' ) {
	return apply_filters( 'bp_progenitor_current_user_can', is_user_logged_in(), $capability, bp_loggedin_user_id() );
}

/**
 * BP Progenitor will not use this hooks anymore
 *
 * @since 1.0.0
 *
 * @return array the list of disused legacy hooks
 */
function bp_progenitor_get_forsaken_hooks() {
	$forsaken_hooks = array(
		'bp_members_directory_member_types' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'the \'bp_members_directory_member_types\' action will soon be deprecated in the BP Progenitor template pack, use the \'bp_progenitor_get_members_directory_nav_items\' filter instead',
		),
		'bp_before_activity_type_tab_all' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'the \'bp_before_activity_type_tab_all\' action will soon be deprecated in the BP Progenitor template pack, use the \'bp_progenitor_get_activity_directory_nav_items\' filter instead',
		),
		'bp_before_activity_type_tab_friends' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'the \'bp_before_activity_type_tab_friends\' action will soon be deprecated in the BP Progenitor template pack, use the \'bp_progenitor_get_activity_directory_nav_items\' filter instead',
		),
		'bp_before_activity_type_tab_groups' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'the \'bp_before_activity_type_tab_groups\' action will soon be deprecated in the BP Progenitor template pack, use the \'bp_progenitor_get_activity_directory_nav_items\' filter instead',
		),
		'bp_before_activity_type_tab_favorites' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'the \'bp_before_activity_type_tab_favorites\' action will soon be deprecated in the BP Progenitor template pack, use the \'bp_progenitor_get_activity_directory_nav_items\' filter instead',
		),
		'bp_before_activity_type_tab_mentions' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'the \'bp_before_activity_type_tab_mentions\' action will soon be deprecated in the BP Progenitor template pack, use the \'bp_progenitor_get_activity_directory_nav_items\' filter instead',
		),
		'bp_activity_type_tabs' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'the \'bp_activity_type_tabs\' action will soon be deprecated in the BP Progenitor template pack, use the \'bp_progenitor_get_activity_directory_nav_items\' filter instead',
		),
		'bp_groups_directory_group_filter' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'the \'bp_groups_directory_group_filter\' action will soon be deprecated in the BP Progenitor template pack, use the \'bp_progenitor_get_activity_directory_nav_items\' filter instead',
		),
		'bp_blogs_directory_blog_types' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'the \'bp_blogs_directory_blog_types\' action will soon be deprecated in the BP Progenitor template pack, use the \'bp_progenitor_get_activity_directory_nav_items\' filter instead',
		),
		'bp_members_directory_order_options' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_members_directory_order_options\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_members_filters\' filter instead',
		),
		'bp_groups_members_order_options' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_groups_members_order_options\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_members_filters\' filter instead',
		),
		'bp_member_friends_order_options' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_member_friends_order_options\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_members_filters\' filter instead',
		),
		...
		'bp_groups_directory_order_options' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_groups_directory_order_options\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_groups_filters\' filter instead',
		),
		'bp_member_group_order_options' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_member_group_order_options\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_groups_filters\' filter instead',
		),
		'bp_member_blog_order_options' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_member_blog_order_options\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_blogs_filters\' filter instead',
		),
		'bp_blogs_directory_order_options' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_blogs_directory_order_options\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_blogs_filters\' filter instead',
		),
		'bp_activity_entry_meta' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_activity_entry_meta\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_activity_entry_buttons\' filter instead',
		),
		'bp_member_header_actions' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_member_header_actions\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_members_buttons\' filter instead',
		),
		'bp_directory_members_actions' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_directory_members_actions\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_members_buttons\' filter instead',
		),
		'bp_group_members_list_item_action' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_group_members_list_item_action\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_members_buttons\' filter instead',
		),
		'bp_friend_requests_item_action' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_friend_requests_item_action\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_members_buttons\' filter instead',
		),
		'bp_group_header_meta' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_group_header_meta\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_group_meta\' filter instead',
		),
		'bp_directory_members_item' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_directory_members_item\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_member_meta\' filter instead',
		),
		'bp_profile_header_meta' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_profile_header_meta\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_member_meta\' filter instead',
		),
		'bp_group_header_actions' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_group_header_actions\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_groups_buttons\' filter instead',
		),
		'bp_directory_groups_actions' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_directory_groups_actions\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_groups_buttons\' filter instead',
		),
		'bp_group_invites_item_action' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_group_invites_item_action\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_groups_buttons\' filter instead',
		),
		'bp_group_membership_requests_admin_item_action' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_group_membership_requests_admin_item_action\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_groups_buttons\' filter instead',
		),
		'bp_group_manage_members_admin_item' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_group_manage_members_admin_item\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_groups_buttons\' filter instead',
		),
		'bp_directory_blogs_actions' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_directory_blogs_actions\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_blogs_buttons\' filter instead',
		),
		'bp_activity_comment_options' => array(
			'hook_type'    => 'action',
			'message_type' => 'warning',
			'message'      => 'The \'bp_activity_comment_options\' action will soon be deprecated in the BP Progenitor template pack, we recommend you now use the \'bp_progenitor_get_activity_comment_buttons\' filter instead',
		),
		'groups_custom_group_fields_editable' => array(
			'hook_type'    => 'action',
			'message_type' => 'error',
			'message'      => 'The \'groups_custom_group_fields_editable\' action is deprecated in the BP Progenitor template pack, please use \'bp_after_group_details_creation_step\' or \'bp_after_group_details_admin\' instead',
		),
	);

	/*
	 * Add warning messages for people using dynamic filters the BP Progenitor Nav Loop
	...
	if ( $nav_items ) {
		...
		$message = __( 'The \'%s\' filter is not used in the BP Progenitor template pack, please use one of the filters of the BP Progenitor Navigation Loop instead', 'buddypress' );
 ...
 */
function bp_progenitor_parse_hooked_dir_nav( $hook = '', $component = '', $position = 99 ) {
 ...
 * @return array
 */
function bp_progenitor_parse_hooked_options( $hook = '', $filters = array() ) {
	if ( empty( $hook ) ) {
		return $filters;
	}
 ...
 */
function bp_progenitor_get_component_filters( $context = '', $component = '' ) {
	$filters = array();
	...
	if ( 'members' === $component ) {
		$filters = bp_progenitor_get_members_filters( $context );
	} elseif ( 'activity' === $component ) {
		$filters = bp_progenitor_get_activity_filters();
		...
		$filters = bp_progenitor_get_groups_filters( $context );
	} elseif ( 'blogs' === $component ) {
		$filters = bp_progenitor_get_blogs_filters( $context );
	}
 ...
 */
function bp_progenitor_get_temporary_setting( $option = '', $retval = false ) {
	...
	if ( 'any' === $option ) {
		...
		foreach ( $temporary_setting as $key => $setting ) {
			if ( 0 !== strpos( $key, 'bp_progenitor_appearance' ) ) {
				continue;
			}
	...
	} elseif ( isset( $temporary_setting['bp_progenitor_appearance[' . $option . ']'] ) ) {
		$retval = $temporary_setting['bp_progenitor_appearance[' . $option . ']'];

	// Used when it's an ajax request
	} elseif ( isset( $_POST['customized'][ 'bp_progenitor_appearance_' . $option ] ) ) {
		$retval = $_POST['customized'][ 'bp_progenitor_appearance_' . $option ];
	}
...
/**
 * Get the BP Progenitor Appearance settings.
 *
 * @since 1.0.0
 *
...
function bp_progenitor_get_appearance_settings( $option = '' ) {
	...
	$settings = bp_parse_args(
		bp_get_option( 'bp_progenitor_appearance', array() ),
		$default_args,
		'progenitor_appearance_settings'
	);
 ...
 */
function bp_progenitor_customizer_grid_choices( $type = 'option' ) {
	$columns = array(
 ...
 */
function bp_progenitor_sanitize_nav_order( $option = '' ) {
 ...
 * @return string
 */
function bp_progenitor_theme_cover_image( $params = array() ) {
	if ( empty( $params ) ) {
		return '';
	}
 ...
 */
function bp_progenitor_get_user_feedback( $feedback_id = '' ) {
	/**
	 * Filter to add your custom feedback messages
	 *
	 * @param array $value The list of feedback messages.
	 */
	$feedback_messages = apply_filters( 'bp_progenitor_feedback_messages', array(
	 ...
	 */
	return apply_filters( 'bp_progenitor_get_user_feedback', $feedback_messages[ $feedback_id ] );
}
 ...
 */
function bp_progenitor_get_signup_fields( $section = '' ) {
	if ( empty( $section ) ) {
		return false;
	}
	 ...
	 */
	$fields = apply_filters( 'bp_progenitor_get_signup_fields', array(
 ...
 */
function bp_progenitor_get_submit_button( $action = '' ) {
	if ( empty( $action ) ) {
		return false;
	}
	 ...
	 * @return array|false
	 */
	$actions = apply_filters( 'bp_progenitor_get_submit_button', array(
		'register' => array(
		...
		'member-group-invites' => array(
			'nonce'  => 'bp_progenitor_group_invites_settings',
			'attributes' => array(
 ...
 */
function bp_progenitor_set_nav_item_order( $nav = null, $order = array(), $parent_slug = '' ) {
