 ...
 * @since 1.0
 */
class BP_Progenitor_Group_Invite_Query extends BP_User_Query {
	/**
 ...
 * @since 1.0.0
 */
class BP_Progenitor_Customizer_Group_Nav extends BP_Core_Nav {
	/**
	 * Constructor
	 *
	...
	protected function setup_nav() {
		...
		add_filter( '_bp_progenitor_group_reset_front_template', array( $this, 'all_groups_fronts' ), 10, 1 );

		$front_template = bp_groups_get_front_template( $this->group );

		remove_filter( '_bp_progenitor_group_reset_front_template', array( $this, 'all_groups_fronts' ), 10, 1 );
	...
	public function get_group_nav() {
		...
		bp_progenitor_set_nav_item_order( $this, bp_progenitor_get_appearance_settings( 'group_nav_order' ), $this->group->slug );
