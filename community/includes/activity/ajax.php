...
bp_progenitor_register_ajax_actions( array(
	array( 'activity_filter'                 => array( 'function' => 'bp_progenitor_ajax_object_template_loader',      'nopriv' => true ) ),
	array( 'get_single_activity_content'     => array( 'function' => 'bp_progenitor_ajax_get_single_activity_content', 'nopriv' => true ) ),
	array( 'activity_mark_fav'               => array( 'function' => 'bp_progenitor_ajax_mark_activity_favorite',      'nopriv' => false ) ),
	array( 'activity_mark_unfav'             => array( 'function' => 'bp_progenitor_ajax_unmark_activity_favorite',    'nopriv' => false ) ),
	array( 'activity_clear_new_mentions'     => array( 'function' => 'bp_progenitor_ajax_clear_new_mentions',          'nopriv' => false ) ),
	array( 'delete_activity'                 => array( 'function' => 'bp_progenitor_ajax_delete_activity',             'nopriv' => false ) ),
	array( 'new_activity_comment'            => array( 'function' => 'bp_progenitor_ajax_new_activity_comment',        'nopriv' => false ) ),
	array( 'bp_progenitor_get_activity_objects' => array( 'function' => 'bp_progenitor_ajax_get_activity_objects',        'nopriv' => false ) ),
	array( 'post_update'                     => array( 'function' => 'bp_progenitor_ajax_post_update',                 'nopriv' => false ) ),
	array( 'bp_spam_activity'                => array( 'function' => 'bp_progenitor_ajax_spam_activity',               'nopriv' => false ) ),
) );
 ...
 */
function bp_progenitor_ajax_mark_activity_favorite() {
	...
	// Nonce check!
	if ( empty( $_POST['nonce'] ) || ! wp_verify_nonce( $_POST['nonce'], 'bp_progenitor_activity' ) ) {
		wp_send_json_error();
	}
 ...
 * @return string JSON reply
 */
function bp_progenitor_ajax_unmark_activity_favorite() {
	// Bail if not a POST action.
	if ( 'POST' !== strtoupper( $_SERVER['REQUEST_METHOD'] ) ) {
		wp_send_json_error();
	}
 ...
 * @return string JSON reply
 */
function bp_progenitor_ajax_clear_new_mentions() {
	// Bail if not a POST action.
	if ( 'POST' !== strtoupper( $_SERVER['REQUEST_METHOD'] ) ) {
		wp_send_json_error();
	}
 ...
 * @return string JSON reply.
 */
function bp_progenitor_ajax_delete_activity() {
	$response = array(
		'feedback' => sprintf(
 ...
 * @return string JSON reply
 */
function bp_progenitor_ajax_get_single_activity_content() {
	$response = array(
		'feedback' => sprintf(
			'<div class="bp-feedback bp-messages error">%s</div>',
	 ...
	 */
	do_action_ref_array( 'bp_progenitor_get_single_activity_content', array( &$activity ) );
 ...
 * @return string JSON reply
 */
function bp_progenitor_ajax_new_activity_comment() {
 ...
 * @return string JSON reply
 */
function bp_progenitor_ajax_get_activity_objects() {
	$response = array();
	...
	if ( 'group' === $_POST['type'] ) {
		...
		wp_send_json_success( array_map( 'bp_progenitor_prepare_group_for_js', $groups['groups'] ) );
	} else {
		$response = apply_filters( 'bp_progenitor_get_activity_custom_objects', $response, $_POST['type'] );
	}
 ...
 * @return string JSON reply
 */
function bp_progenitor_ajax_post_update() {
	$bp = buddypress();
	...
	wp_send_json_success( array(
		...
		'activity'     => $acivity,
		'is_private'   => apply_filters( 'bp_progenitor_ajax_post_update_is_private', $is_private ),
 ...
 * @return string JSON reply.
 */
function bp_progenitor_ajax_spam_activity() {
	$bp = buddypress();
