...
( function( exports, $ ) {
	...
	bp.Progenitor.Notifications = {
		...
		setupGlobals: function() {
			...
			bp.Progenitor.setStorage( 'bp-notifications', 'extras', 'DESC' );
		},
		...
		addListeners: function() {
			...
			$( '#buddypress [data-bp-list="notifications"]' ).on( 'click', '[data-bp-notifications-order]', bp.Progenitor, this.sortNotifications );
		...
		prepareDocument: function() {
			var store = bp.Progenitor.getStorage( 'bp-notifications' );
		...
		sortNotifications: function( event ) {
			...
			bp.Progenitor.setStorage( 'bp-notifications', 'extras', sort );
		...
		resetFilter: function() {
			bp.Progenitor.setStorage( 'bp-notifications', 'filter', 0 );
		}
	};

	// Launch BP Progenitor Notifications
	bp.Progenitor.Notifications.start();
